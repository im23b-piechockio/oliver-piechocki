...
export const content = {
  en: {
    ...
    skills: [
      ...
      { title: "IT & Technology", desc: "Hands-on interest in modern IT systems, software and how technology drives value.", icon: "chip" },
      { title: "Business & Economy", desc: "Passionate about business and economics, bridging the technical and commercial.", icon: "chart" },
    ...
    projects: [
      { ...projectMeta.mensa, title: "Mensa App", tag: "Full-stack · School", desc: "A cafeteria (Mensa) app for the Bildungszentrum Zürichsee in Horgen, letting students browse and manage meal offerings. Built with a Java backend and a modern Next.js frontend." },
      { ...projectMeta.creatine, title: "Creatine Info Page", tag: "Web · Health", desc: "An interactive, science-backed information site about creatine, featuring a weight-based dosage calculator, an AI chat assistant and an animated FAQ." },
      { ...projectMeta.enerlytics, title: "Enerlytics", tag: "Data · Python", desc: "A data-visualization tool that parses energy data (ESL and SDAT formats) and turns it into clear, interactive graphs through a Flask web interface." },
    ...
    interests: ["Information Technology", "Business & Economy", "Finance & Investing", "Health & Sports", "Fitness & Athletics", "Continuous Learning"],
    ...
    ui: {
      ...
      sections: {
        ...
        contact: { eyebrow: "Contact", title: "Let's talk", sub: "Open to apprenticeships, internships and opportunities in IT and business. Reach out, I usually reply quickly." },
      },
      ...
      contactUi: { email: "Email", call: "Call", location: "Location", name: "Name", emailField: "Email", message: "Message", send: "Send message", sent: "Opening your mail app…", namePh: "Your name", emailPh: "you@example.com", messagePh: "Tell me a little about the opportunity…" },
  ...
  de: {
    ...
    skills: [
      ...
      { title: "IT & Technologie", desc: "Praktisches Interesse an modernen IT-Systemen, Software und daran, wie Technologie Mehrwert schafft.", icon: "chip" },
      { title: "Wirtschaft & Ökonomie", desc: "Begeistert von Wirtschaft und Ökonomie und davon, Technik und Kaufmännisches zu verbinden.", icon: "chart" },
    ...
    projects: [
      { ...projectMeta.mensa, title: "Mensa-App", tag: "Full-Stack · Schule", desc: "Eine Mensa-App für das Bildungszentrum Zürichsee in Horgen, mit der Schülerinnen und Schüler das Menüangebot durchsehen und verwalten können. Mit Java-Backend und modernem Next.js-Frontend." },
      { ...projectMeta.creatine, title: "Kreatin-Infoseite", tag: "Web · Gesundheit", desc: "Eine interaktive, wissenschaftlich fundierte Info-Seite über Kreatin, mit gewichtsbasiertem Dosierungsrechner, KI-Chat-Assistent und animiertem FAQ." },
      { ...projectMeta.enerlytics, title: "Enerlytics", tag: "Daten · Python", desc: "Ein Datenvisualisierungs-Tool, das Energiedaten (ESL- und SDAT-Format) einliest und über eine Flask-Weboberfläche in klare, interaktive Diagramme umwandelt." },
    ...
    interests: ["Informationstechnologie", "Wirtschaft & Ökonomie", "Finanzen & Investieren", "Gesundheit & Sport", "Fitness & Athletik", "Ständiges Lernen"],
    ...
    ui: {
      ...
      sections: {
        ...
        contact: { eyebrow: "Kontakt", title: "Sprechen wir", sub: "Offen für Lehrstellen, Praktika und Chancen in IT und Wirtschaft. Melde dich, ich antworte meist schnell." },
      },
      ...
      contactUi: { email: "E-Mail", call: "Anrufen", location: "Standort", name: "Name", emailField: "E-Mail", message: "Nachricht", send: "Nachricht senden", sent: "Öffne deine Mail-App…", namePh: "Dein Name", emailPh: "du@beispiel.com", messagePh: "Erzähl mir kurz von der Gelegenheit…" },
