...
export const content = {
  en: {
    ...
    ui: {
      ...
      contactUi: { email: "Email", call: "Call", location: "Location", name: "Name", emailField: "Email", message: "Message", send: "Send message", sending: "Sending…", success: "Thank you! Your message has been sent.", error: "Something went wrong. Please email me directly.", sent: "Opening your mail app…", namePh: "Your name", emailPh: "name@company.com", messagePh: "What is it about?" },
  ...
  de: {
    ...
    ui: {
      ...
      contactUi: { email: "E-Mail", call: "Anrufen", location: "Standort", name: "Name", emailField: "E-Mail", message: "Nachricht", send: "Nachricht senden", sending: "Wird gesendet…", success: "Danke! Ihre Nachricht wurde gesendet.", error: "Etwas ist schiefgelaufen. Bitte schreiben Sie mir direkt eine E-Mail.", sent: "Ihr Mailprogramm wird geöffnet…", namePh: "Ihr Name", emailPh: "name@firma.ch", messagePh: "Worum geht es?" },
